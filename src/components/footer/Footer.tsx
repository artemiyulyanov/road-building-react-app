...
export type FooterProps = React.HTMLProps<HTMLDivElement> & {
    footerSitemap: Array<SitemapLink>
}
        ...
        <div className={clsx(
            ...
            <div className={clsx(
                ...
                <div className={clsx(
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <PlainText
                            textClassName={clsx(
                                "relative font-medium break-words",
                                "text-sm xl:text-base  text-light/50"
                            )}
                        >
                            ...
                            >
                                ...
                                >
                                    <PlainText
                                        textClassName={clsx(
                                            "relative font-medium break-words",
                                            "text-sm xl:text-base  text-light"
                                        )}
                                    >
                                        {link.text}
                                    </PlainText>
                ...
                <PlainText
                    textClassName={clsx(
                        "relative font-medium break-words",
                        "text-xs xl:text-sm  text-light/50"
                    )}
                >
