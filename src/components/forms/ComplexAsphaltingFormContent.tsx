...
export type ComplexAsphaltingFormContentProps = React.HTMLProps<HTMLDivElement> & {
    submissionStatus: number | undefined
    setSubmissionStatus: React.Dispatch<React.SetStateAction<number | undefined>>
}

export const ComplexAsphaltingFormContent: React.FC<ComplexAsphaltingFormContentProps> = ({
    submissionStatus,
    setSubmissionStatus
}) => {
    const {
    ...
    } = useForm<ComplexAsphaltingFormData>({
        mode: 'onChange'
    });
