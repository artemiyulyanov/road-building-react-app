...
export type TurnkeyAsphaltingClauseProps = React.HTMLProps<HTMLDivElement> & {
    number: '01' | '02' | '03'
    text: string
    items: 'left' | 'right'
...
export const TurnkeyAsphaltingClause: React.FC<TurnkeyAsphaltingClauseProps> = ({
    items,
    number,
    text,
    wrapperClassName,
        ...
        >
            ...
            <PlainText
                textClassName={clsx(
                    ...
                    "text-base sm:text-base xl:text-xl  text-light",
...
//                     textClassName={clsx(
//                         "relative font-medium break-words w-full",
//                         "text-base sm:text-lg lg:text-xl  text-light",
//                         (items == 'left') && 'text-left',
//                         (items == 'right') && 'text-right'
//                     )}
//                 >
