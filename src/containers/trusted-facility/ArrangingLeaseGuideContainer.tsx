...
export type ArrangingLeaseGuideContainerProps = React.HTMLProps<HTMLDivElement>
...
const clauses: Array<PaintedCardClause> = [
    {
        "title": "Оставьте заявку по телефону или через сайт",
        "theme": "transparent",
        "digit": "01"
    },
    {
        "title": "Сообщите, какая техника требуется, место проведения работ и сроки аренды",
        "theme": "light",
        "digit": "02"
    },
    {
        "title": "Подготовим коммерческое предложение и согласуем стоимость",
        "theme": "yellow",
        "digit": "03"
    },
    {
        "title": "Заключение договора об оказании услуг",
        "theme": "transparent",
        "digit": "04"
    },
    {
        "title": "Подаём технику точно в согласованное время",
        "theme": "light",
        "digit": "05"
    },
]

export const ArrangingLeaseGuideContainer: React.FC<ArrangingLeaseGuideContainerProps> = ({
    ...
    return (
        <div 
            ...
            id="arranging-lease-guide-container"
        >
            <PlainText
                textClassName={clsx(
