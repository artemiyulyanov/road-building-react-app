...
export type PlacingOrderGuideContainerProps = React.HTMLProps<HTMLDivElement>
...
const clauses: Array<PaintedCardClause> = [
    ...
    {
        "title": "Менеджер уточнит необходимую марку смеси, объём и адрес доставки",
        "theme": "light",
        "digit": "02"
    },
    {
    ...
    {
        "title": "Изготовим свежую смесь",
        "theme": "transparent",
        "digit": "04"
    },
    {
        "title": "Выполним своевременную отгрузку или доставку на объект",
        "theme": "light",
        "digit": "05"
    },
]

export const PlacingOrderGuideContainer: React.FC<PlacingOrderGuideContainerProps> = ({
    ...
    return (
        <div 
            ...
            id="placing-order-guide-container"
        >
            <PlainText
                textClassName={clsx(
