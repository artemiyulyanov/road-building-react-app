                                ...
                                <div className={clsx(
                                    ...
                                    <PlainText
                                        textClassName={clsx(
                                            ...
                                            "text-xl lg:text-2xl xl:text-3xl  text-dark text-left"
                                        )}
                                    >
                                    ...
                                    <PlainText
                                        textClassName={clsx(
                                            ...
                                            "text-base lg:text-lg xl:text-xl  text-dark text-left"
                                        )}
                                    >
                ...
                >
                    ...
                    <div className={clsx(
                        ...
                        <PlainText
                            textClassName={clsx(
                                "relative font-medium break-words",
                                "text-2xl xl:text-3xl  text-dark"
                            )}
                        >
                            Производим асфальт на заказ
                        </PlainText>
                        <PlainText
                            textClassName={clsx(
                                "relative opacity-50 font-medium",
                                "text-base xl:text-xl  text-dark"
                            )}
                        >
