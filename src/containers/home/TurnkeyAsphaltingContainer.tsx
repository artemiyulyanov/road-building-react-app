...
import { TurnkeyAsphaltingClause } from "@/components/home/TurnkeyAsphaltingClause";
                    ...
                    <div className={clsx(
                        ...
                        <PlainText
                            textClassName={clsx(
                                ...
                                "text-xl lg:text-2xl xl:text-3xl  text-light"
                            )}
                        >
                        ...
                        <PlainText
                            textClassName={clsx(
                                ...
                                "text-base lg:text-lg xl:text-xl  text-light text-left"
                            )}
                        >
